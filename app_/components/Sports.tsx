              ...
              <div className="section-card">
                ...
                <div className="section-content">
                  ...
                  <div className="section-icon2" >
                    <NextImage src="/images/casino_1.png"  alt="Company Logo"  width={164}  height={164} priority/>
                        </div>
                </div>
              </div>
              <div className="section-card">
                ...
                <div className="section-content">
                  <p className="section-text">veniam dolore consectetur lorem<br/>aliqua ad dolor minim adipiscing</p>
                  <div className="section-icon2" >
                    <NextImage src="/images/sports_1.png"  alt="Company Logo"  width={164}  height={164} priority />                   
                  </div>
                </div>
              </div>
            </div>
