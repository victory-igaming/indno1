...
const gameId = `dgbzqi1v9d1qeqh6dr7ldc2i`;
const basePath = `cockfight`;
 ...
 return (
    ...
    {/* SIDEBAR */}
           ...
           <div className="live-section">
                ...
                <GamesClient  gamebody={playgames} pagination={pagination} currentPage={currentPage} basePath={basePath} />
